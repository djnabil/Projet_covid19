...
$(document).ready(function(){
  $.getJSON("https://api.npoint.io/585d834c336fa48f79e3", function(data){
  $.each(data, function(i, d){
 
  OldMin = 0;NewMin=35;
  OldRange = (7000000 - 0)  
  NewRange = (350 - 35)  
  NewValue = (((d.cases - OldMin) * NewRange) / OldRange) + NewMin
  console.log(NewValue)
  if(NewValue>350)
    NewValue = 450
  var monImage = "<img src='" + d.flag + "' style='width:"+ NewValue +"px;'/>";

  $("#espace").append(monImage);
  });
});
});
